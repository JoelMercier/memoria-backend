...
Create Table "Providers" (
    ...
    "apOrdreAff"   Smallint Not Null,                             -- 2 octets [Affichage humain] [Mémoria]
    "apIdProvider" Char(4) Not Null,                              -- 4 octets fixes (Quadrigramme unique) [Mémoria]
    ...
    Constraint "Providers_apOrdreAff_Udx" Unique ("apOrdreAff"), -- Tri ergonomique exclusif [Mémoria]
...
-- ----------------------------------------------------------------------------
Create Trigger "Providers_BeforeUpdate_Trg"
...
Comment On Column "Providers"."apUpdatedAt" is 'Horodatage système automatique de la modification via le trigger TraceModif.';
