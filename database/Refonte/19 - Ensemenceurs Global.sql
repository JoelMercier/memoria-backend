...
("Bin-UUID"(decode('018d5c8e567870019001000000000001', 'hex')),'sophie.laurent@tech.io','$2b$10$X7','SophieDev','CUST','LOCA','{"theme":"dark","notifications":true}'::jsonb,true,'2024-01-15 10:00:00','2024-01-15 10:00:00'),
("Bin-UUID"(decode('018d5c8e567870019001000000000002', 'hex')),'marc.dubois@entreprise.fr','$2b$10$Y8','MarcPM','CUST','LOCA','{"theme":"light","notifications":false}'::jsonb,true,'2024-01-15 10:30:00','2024-01-15 10:30:00'),
("Bin-UUID"(decode('018d5c8e567870019001000000000003', 'hex')),'emma.martin@universite.fr','$2b$10$Z9','EmmaPsy','CUST','LOCA','{"theme":"dark","notifications":true}'::jsonb,true,'2024-01-15 11:00:00','2024-01-15 11:00:00'),
("Bin-UUID"(decode('018d5c8e567870019001000000000004', 'hex')),'lucas.lefevre@design.com','$2b$10$W6','LucasDesign','CUST','LOCA','{"theme":"dark","notifications":false}'::jsonb,true,'2024-01-15 11:30:00','2024-01-15 11:30:00'),
...
("Bin-UUID"(decode('018d5c8e567870019001000000000010', 'hex')),'maxime.infra@memoria.io','$2b$10$M5','MaximeInfra','ADMN','LOCA','{"theme":"dark","admin_dashboard":true}'::jsonb,true,'2024-01-15 09:00:00','2024-01-15 09:00:00'),
...
("Bin-UUID"(decode('018d5c8e567870019001000000000012', 'hex')),'pierre.root@memoria.io','$2b$10$R7','PierreRoot','SADM','LOCA','{"theme":"dark","root_access":true}'::jsonb,true,'2024-01-15 08:00:00','2024-01-15 08:00:00')
...
Insert Into "Users" (
    ...
    "usRoleId", "usProviderId", "usSettingsUser", "usGdprConsent", "usGdprDate", "usCreatedAt"
) Values
...
-- ----------------------------------------------------------------------------
Insert Into "Items" (
    "itCreatedAt", "itUpdatedAt", "itIdItem", "itUserId", "itContentTypeId",
    "itTitle", "itSlug", "itSourceAuthor", "itThumbnailUrl", "itMetadata", "itContent"
) Values
('2024-01-15 10:15:00', NULL, "Bin-UUID"(decode('018d5c8e80017001b001000000000001', 'hex')), "Bin-UUID"(decode('018d5c8e567870019001000000000001', 'hex')), 'ARTI', 'Les principes SOLID en JavaScript', 'les-principes-solid-en-javascript', 'Robert C. Martin', 'https://unsplash.com', '{"reading_time":"8 min"}'::jsonb, 'S : Responsabilité unique. O : Ouvert/Fermé. L : Substitution de Liskov. I : Séparation des interfaces. D : Inversion des dépendances.'),
('2024-01-15 10:20:00', NULL, "Bin-UUID"(decode('018d5c8e80017001b001000000000002', 'hex')), "Bin-UUID"(decode('018d5c8e567870019001000000000001', 'hex')), 'ARTI', 'React Server Components', 'react-server-components', 'Dan Abramov', 'https://unsplash.com', '{"reading_time":"12 min"}'::jsonb, 'Les RSC s exécutent uniquement sur le serveur. Ils réduisent la taille du bundle JavaScript envoyé au client.'),
('2024-01-15 10:40:00', NULL, "Bin-UUID"(decode('018d5c8e80017001b002000000000001', 'hex')), "Bin-UUID"(decode('018d5c8e567870019001000000000002', 'hex')), 'BOOK', 'Le Guide du Scrum Officiel 2024', 'le-guide-du-scrum-officiel-2024', 'Ken Schwaber', 'https://unsplash.com', '{"pages":16}'::jsonb, 'Scrum est un cadre de travail léger qui aide les personnes, les équipes et les organisations à générer de la valeur.'),
('2024-01-15 11:10:00', NULL, "Bin-UUID"(decode('018d5c8e80017001b003000000000001', 'hex')), "Bin-UUID"(decode('018d5c8e567870019001000000000003', 'hex')), 'BOOK', 'Thinking, Fast and Slow', 'thinking-fast-and-slow-daniel-kahneman', 'Daniel Kahneman', 'https://unsplash.com', '{"pages":499}'::jsonb, 'Système 1 : rapide, automatique. Système 2 : lent, réfléchi. L aversion aux pertes est plus forte que l attrait du gain.')
On Conflict Do Nothing;
...
-- ----------------------------------------------------------------------------
Insert Into "Events" (
    "aeCreatedAt", "aeIdEvent", "aeUserId", "aeCategoryId", "aeIdSeverity", "aeType", "aeMessage", "aeMetadata") Values

-- 1. Log Système : Démarrage de l'application
('2024-01-15 09:10:04', "Bin-UUID"(decode('018d5c8ea0017001d002000000000001', 'hex')), NULL, 'MONI', 'INFO', 'systeme.demarrage', 'Application Memoria démarrée avec succès', '{"version":"1.0.0"}'::jsonb),

-- 2. Log Acteur : Inscription de Sophie
('2024-01-15 10:00:01', "Bin-UUID"(decode('018d5c8ea0017001d002000000000003', 'hex')), "Bin-UUID"(decode('018d5c8e567870019001000000000001', 'hex')), 'ANAL', 'INFO', 'utilisateur.enregistrement', 'Nouvel utilisateur enregistré', '{"ip":"192.168.1.15"}'::jsonb),

-- 3. Log Sécurité : Échec d'authentification d Emma (Poids 20 - Avertissement)
('2024-01-15 11:02:00', "Bin-UUID"(decode('018d5c8ea0017001d002000000000010', 'hex')), "Bin-UUID"(decode('018d5c8e567870019001000000000003', 'hex')), 'AUDI', 'WARN', 'authentification.echec', 'Tentative de connexion échouée', '{"retry_count":1}'::jsonb),

-- 4. Log RGPD : Demande d'exportation d Alice
('2024-01-15 12:05:00', "Bin-UUID"(decode('018d5c8ea0017001d002000000000020', 'hex')), "Bin-UUID"(decode('018d5c8e567870019001000000000005', 'hex')), 'RGPD', 'INFO', 'rgpd.exportation', 'Exportation complète demandée', '{"format":"json"}'::jsonb),

-- 5. Log Performance : Alerte requête lente sur Items (Poids 20 - Avertissement)
('2024-01-15 13:45:12', "Bin-UUID"(decode('018d5c8ea0017001d002000000000099', 'hex')), NULL, 'MONI', 'WARN', 'bd.requete_lente', 'Requête SQL lente détectée sur la table items', '{"duration_ms":1250}'::jsonb)
On Conflict Do Nothing;
