...
Create Table "ContentTypes" (
    ...
    "ctOrdreAff"      Smallint Not Null,                             -- 2 octets [Affichage humain] [Mémoria]
    "ctIdContentType" Char(4) Not Null,                              -- 4 octets fixes (Quadrigramme unique) [Mémoria]
...
-- ----------------------------------------------------------------------------
Create Trigger "ContentTypes_BeforeUpdate_Trg"
...
(10, 'NOTE', 'Note'), -- Présenté en premier pour la capture rapide à blanc [Mémoria]
(20, 'ARTI', 'Article'),
(30, 'BOOK', 'Livre'),
(40, 'PODC', 'Podcast'),
(50, 'VIDE', 'Vidéo')
