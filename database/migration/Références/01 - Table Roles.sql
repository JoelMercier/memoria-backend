...
Create Table "Roles" ( -- Ordre physique des zones optimisé pour réduire le «padding» (remplissage par des blancs pour aligner sur 64 bits)
    ...
    Constraint "Roles_roNiveau_Chk" Check ("roNiveau" >= 0),    -- Pour plus de clarté
