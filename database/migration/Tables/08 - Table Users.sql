...
Create Table "Users" (
    "usIdUser"         UUID,                                         -- 16 octets bruts fixes ( => classe IdBinaire)
    "usCreatedAt"      Timestamp Not Null Default Current_Timestamp, --  8 octets fixes (Date de création)
    "usUpdatedAt"      Timestamp,                                    --  8 octets fixes (Géré par notre trigger universel)
    "usRgpdDate"       Timestamp,                                    --  8 octets fixes (Horodatage universel UTC)
    ...
    "usCourriel"       Varchar(254) Not Null,                        -- Variable (Le nettoyeur linguistique francisé)
    ...
    Constraint "Users_usIdUser_Taille_Chk"  Check (octet_length("UUID-Bin"("usIdUser")) = 16),
...
Create Unique Index "Users_usCourriel_Lower_Udx" On "Users" (Lower("usCourriel"));
-- ----------------------------------------------------------------------------
