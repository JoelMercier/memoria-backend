...
export class MockDataSeeder {
  ...
  await p_oPivotRepo.add(l_oIdItemScrum, l_oIdTagAgile);
    ...
    await p_oShareRepo.create({ idShare: l_oIdShareSophie, shIdShare: l_oIdShareSophie, shItemId: l_oIdItemSolid, itemOwnerId: l_oIdSophie, shCourrielDest: 'marc.dubois@entreprise.fr', shJeton: 'tok_share_sophie_marc_001', shConfiguration: { level: 'read', allow_download: false } });
    await p_oShareRepo.create({ idShare: l_oIdShareMarc, shIdShare: l_oIdShareMarc, shItemId: l_oIdItemScrum, itemOwnerId: l_oIdMarc, shCourrielDest: 'sophie.laurent@tech.io', shJeton: 'tok_share_marc_sophie_001', shConfiguration: { level: 'read', allow_download: true } });
  }
}
