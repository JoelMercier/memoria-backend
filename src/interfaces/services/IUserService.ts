 ...
 */
export interface IUserService extends IBaseService<User, IUserData, UserId, IUserRepository>  {
   ...
   * @returns {Promise<User>} L'entité de l'utilisateur révisée et mise à jour
   */
  updateProfile(p_axUserId: UserId, p_oDto: UpdateProfileDto): Promise<User>;
