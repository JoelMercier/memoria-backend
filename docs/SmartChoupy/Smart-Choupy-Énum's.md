...
Pour résoudre cette équation, nous avons implémenté une convergence de trois *Design Patterns* majeurs du Gang des Quatre (GoF), appliqués au niveau matériel de la RAM.
